...
This routine will load a bam file (i.e. a binary SAM file), excise the sequences overlapping the regions listed in file "regions" (as "chr start end"), and print them out in "fastq format":http://en.wikipedia.org/wiki/FASTQ_format.
